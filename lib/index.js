...
const SUPERVISOR_ENV = "DSH_SELF_UPDATE_SUPERVISOR";
/**
...
function detectSupervisor(env = process.env) {
	...
	if (env["INVOCATION_ID"] !== void 0 && env["INVOCATION_ID"] !== "") return "systemd";
	if (env["pm_id"] !== void 0 || env["PM2_HOME"] !== void 0) return "pm2";
	return "none";
}
function resolveRestartMode(supervisor, platform = process.platform) {
...
*/
function buildRespawnArgs(input) {
	return [
		"/bin/sh",
		"-c",
...
* 没人接管的情况下退出。
*/
function spawnRespawner(logPath) {
