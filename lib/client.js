...
const ZH = {
	...
	divergedAhead: (n, ref) => `本地领先 ${ref} ${n} 个提交：`,
	divergedMore: (n) => `…另有 ${n} 个提交未列出`,
	realignWhat: (branch, ref) => `「备份并对齐远端」会先把当前 HEAD 存成分支 ${branch}（提交一个都不丢，随时能切回去），再把工作副本硬重置到 ${ref}，然后照常装依赖、重建前端。`,
	realignDirty: "工作区有未提交改动——重置会抹掉它们。先自行处理 git status 再来对齐。",
	realignBtn: "备份本地提交并对齐远端",
	backupSaved: (branch) => `本地提交已备份到分支 ${branch}。`,
	checking: "正在检查更新…",
	upToDate: "已是最新版本",
...
const EN = {
	...
	divergedMore: (n) => `…and ${n} more not listed`,
	realignWhat: (branch, ref) => `“Back up and align to remote” saves the current HEAD as branch ${branch} (no commit is lost — you can switch back any time), hard-resets the working copy to ${ref}, then installs deps and rebuilds as usual.`,
	realignDirty: "Uncommitted changes would be wiped by the reset. Clean up git status first, then align.",
	realignBtn: "Back up local commits and align to remote",
	backupSaved: (branch) => `Local commits are backed up on branch ${branch}.`,
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				needsRestart && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [t.installedRestart, wasRealign && status.backupBranch !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							color: T$1.text3,
							marginTop: 6
						},
