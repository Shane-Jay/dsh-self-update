		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				blocked && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: status.dirty ? `工作区有未提交改动，更新已锁定——不会动你的改动。先处理 ${status.repoRoot} 的 git status。` : "本地有远端没有的提交，无法快进更新。"
				}),
				...
				needsRestart && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: "更新已装好，重启后生效——服务自动拉起，页面随后刷新。"
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: {
						display: "flex",
